<div align="center">
  ...
  <p>
    ...
    <a href="#тестирование"><img alt="81 пройденный тест" src="https://img.shields.io/badge/tests-81%20passing-22A06B"></a>
...
4. **После успешной задачи** host фиксирует ID записи, время, session ID,
   repository HEAD, изменённые пути и реальные test-команды с exit code в
...
наблюдаемые host-данные: реально переданный recall, Git HEAD, dirty paths и
результаты test-команд.
