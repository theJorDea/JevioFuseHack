<div align="center">
  ...
  <p>
    ...
    <a href="#тестирование"><img alt="80 пройденных тестов" src="https://img.shields.io/badge/tests-80%20passing-22A06B"></a>
...
4. **После успешной задачи** Jevio отправляет краткий Markdown и ID активной
   сессии в `/api/v1/remember`, если включён `rememberCompletedTurns`.
5. **При компактизации** checkpoint также записывается в Cognee, если включён
   `rememberCompactions`.
6. **По `/memory improve`** Cognee переносит полезные данные активной сессии в
