<div align="center">
  ...
  <p>
    ...
    <a href="#тестирование"><img alt="83 пройденных теста" src="https://img.shields.io/badge/tests-83%20passing-22A06B"></a>
...
Тест требует `COGNEE_BASE_URL` и `COGNEE_API_KEY`. Он проверяет permanent
