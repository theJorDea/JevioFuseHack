...
Офлайн-набор содержит **150 тестов**,
...
и remote IDs/hash. Для legacy-записей без receipt остаётся ID-фильтр; абсолютная
...
| Реализовано | Retrieval benchmark Cognee on/off | 20 Cloud-сценариев; granular deletion четырёх stale sources измеряется отдельно, прежний baseline — 16/20 |
